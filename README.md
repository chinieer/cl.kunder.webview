...
- __loading__: (iOS)Should enable animate while webview is open. _(Boolean optional)_ (Android)Should show a loading dialog while webview is loading. _(Boolean optional)_
